...
class DCT(nn.Module):
    ...
    def forward(self, x, expk=None): 
        ...
        # print("self.expk shape:",self.expk.shape)
...
class DCT1d(nn.Module):
    def __init__(self, expk=None, algorithm='N'):
        ...
        self.expk = expk
        self.algorithm = algorithm
    def forward(self, x, expk): 
        # print("x shape:",x.shape)
        # print("expk shape:",expk.shape)
        return DCTFunction.apply(x, expk, self.algorithm)
...
class IDCT1d(nn.Module):
    def __init__(self, expk=None, algorithm='N'):
        ...
        self.algorithm = algorithm
    def forward(self, x, expk): 
        return IDCTFunction.apply(x, expk, self.algorithm)
...
class IDXST1d(nn.Module):
    def __init__(self, expk=None):
        super(IDXST1d, self).__init__()
        self.expk = expk
    def forward(self, x, expk): 
        return IDXSTFunction.apply(x, expk)
