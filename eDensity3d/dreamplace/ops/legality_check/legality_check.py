...
class LegalityCheck(object):
    ...
    def __call__(self, pos, node_size_x, node_size_y, num_terminals, num_movable_nodes, row_height = None):
        return self.forward(pos, node_size_x, node_size_y, num_terminals, num_movable_nodes, row_height)

    def forward(self, pos, node_size_x_, node_size_y_, num_terminals_, num_movable_nodes_, row_height):
        """ 
