...
class LegalityCheck(object):
    ...
    def __call__(self, pos, onlyMacro = False):
        return self.forward(pos, onlyMacro)

    def forward(self, pos, onlyMacro = False):
        """ 
        ...
        return legality_check_cpp.forward(
            ...
            self.num_terminals, self.num_movable_nodes, onlyMacro)
