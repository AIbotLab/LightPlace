...
class GreedyLegalize(object):
    ...
    def __call__(self, init_pos, pos, node_size_x_, node_size_y_, num_movable_nodes_, layer_num_fillers, row_height): 
        """ 
        ...
        return GreedyLegalizeFunction.forward(
                ...
                node_size_x=node_size_x_,
                node_size_y=node_size_y_,
