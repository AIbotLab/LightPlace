...
class AbacusLegalize(object):
    ...
    def __init__(self, terminal):
        self.node_size_x = terminal.node_size_x
        self.node_size_y = terminal.node_size_y
        self.node_weights = None
        self.flat_region_boxes = None
        ...
        self.xh = terminal.xh
        self.yh = terminal.yh
        self.site_width = terminal.site_width
        self.row_height = terminal.row_height
        # num_bins_x=1,
        # num_bins_y=64,
        self.num_bins_x = 1
        self.num_bins_y = 64
        self.num_movable_nodes = terminal.num_movable_nodes
        self.num_terminal_NIs = 0
        self.num_filler_nodes = 0
    """
    def __call__(self, init_pos, pos, node_size_x, node_size_y, num_movable_nodes, layer_num_fillers, row_height):
        """ 
